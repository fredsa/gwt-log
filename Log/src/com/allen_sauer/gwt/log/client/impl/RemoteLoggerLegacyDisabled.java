 ...
 * of a property.
 */
public class RemoteLoggerLegacyDisabled implements Logger {

  private RemoteLoggerLegacyDisabled() {
    DOMUtil.reportFatalAndThrowRuntimeException("Please update your project's .gwt.xml file and remove this line:\n"
