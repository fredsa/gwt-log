...
// StackTraceDeobfuscator, copied from GWT at r9383. See
// http://google-web-toolkit.googlecode.com/svn/trunk/user/src/com/google/gwt/logging/server/StackTraceDeobfuscator.java
...
public class StackTraceDeobfuscator {
  ...
  private final Map<String, SymbolMap> symbolMaps = new HashMap<String, SymbolMap>();
  ...
  public StackTraceElement resymbolize(StackTraceElement ste, String strongName) {
    ...
    if (symbolData != null) {
      ...
      if (parts.length == 5) {
        ...
        String filename = "Unknown".equals(parts[3]) ? null : parts[3].substring(
            parts[3].lastIndexOf('/') + 1);
  ...
  protected InputStream getSymbolMapInputStream(String permutationStrongName) throws IOException {
    String filename = symbolMapsDirectory.getCanonicalPath() + File.separatorChar
        + permutationStrongName + ".symbolMap";
